...
from ui.utils.config import Colors, Fonts, Spacing
...
class AboutCompanyPage(QWidget):
    ...
    def create_widgets(self):
        ...
        info_layout.setContentsMargins(Spacing.XL, Spacing.XL, Spacing.XL, Spacing.XL)
    ...
    def create_direction_card(self, icon_name, title_text, description_text):
        ...
        # Иконка
        icon_label = create_icon_label(icon_name, size=40)
