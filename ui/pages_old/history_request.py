...
class HistoryPage(QWidget):
    ...
    def create_widgets(self):
        """Создание элементов интерфейса СТРАНИЦЫ истории закупок"""
        ...
        # 2. Скроллируемая область для карточек
        scroll_area = QScrollArea()
        scroll_area.setWidgetResizable(True)
        scroll_area.setStyleSheet("QScrollArea { border: none; background-color: transparent; }")
        ...
        # Мок-данные для истории закупок
        history_data = [
            {"date": "15.06.2024", "time": "10:30", "number": "125", "description": "Канцелярские товары для офиса",
             "amount": "45 230 ₽", "items_count": 12},
            {"date": "10.06.2024", "time": "14:15", "number": "124", "description": "Расходные материалы для принтеров",
             "amount": "18 750 ₽", "items_count": 7},
            {"date": "05.06.2024", "time": "09:20", "number": "123", "description": "Электротехническая продукция",
             "amount": "76 890 ₽", "items_count": 15},
            {"date": "28.05.2024", "time": "16:45", "number": "122", "description": "Хозяйственные товары",
             "amount": "9 430 ₽", "items_count": 5},
            {"date": "21.05.2024", "time": "11:05", "number": "121", "description": "Компьютерная периферия",
             "amount": "34 560 ₽", "items_count": 9},
        ]
        ...
        # 3. Нижняя панель: кнопка "Назад" + пагинация
        bottom_layout = QHBoxLayout()
        bottom_layout.setSpacing(20)

        # Кнопка "Назад" (теперь переключает на Главную, а не закрывает окно)
        back_btn = QPushButton("← Назад")
        back_btn.setFont(QFont("Segoe UI", 12))
        back_btn.setFixedSize(130, 40)
        back_btn.setObjectName("backButton")
        back_btn.clicked.connect(lambda: self.navigate_to("Главная"))
        bottom_layout.addWidget(back_btn)
        ...
        # 4. Мини-карточка выхода в правом нижнем углу
        exit_layout = QHBoxLayout()
        exit_layout.addStretch()
    ...
    def create_history_card(self, data):
        ...
        card.setObjectName("historyCard")
        card.setFixedHeight(110)
        card.setCursor(Qt.CursorShape.PointingHandCursor)  # Добавим курсор руки для интерактивности
    ...
    def create_pagination(self):
        ...
        for page in pages:
            ...
            # Заглушка для клика по пагинации
    ...
    def show_exit_confirmation(self):
        ...
        cancel_btn.setFixedSize(150, 45)
        cancel_btn.setStyleSheet("""
            QPushButton { background-color: #F3F4F6; color: #374151; border: 1px solid #D1D5DB; border-radius: 8px; }
    ...
    def apply_styles(self):
        ...
        #         border-radius: 6px;
        #     }
        #     #openButton:hover { background-color: #DBEAFE; }
        #
        #     #exportButton {
        #         background-color: #FFFFFF;
        #         color: #374151;
        ...
        #         border-radius: 6px;
        #     }
        #     #exportButton:hover { background-color: #F3F4F6; }
        #
        #     #deleteButton {
        #         background-color: #FFFFFF;
        #         color: #EF4444;
        ...
        #         border-radius: 8px;
        #     }
        #     #backButton:hover { background-color: #F3F4F6; }
        #
        #     /* Стили пагинации */
        #     #currentPage {
        #         background-color: #3B82F6;
        ...
        #         border-radius: 6px;
        #     }
        #     #pageButton:hover { background-color: #F3F4F6; }
        #
        #     #navButton {
        #         background-color: #FFFFFF;
        #         color: #6B7280;
