...
class AboutPage(QWidget):
    ...
    def create_widgets(self):
        """Создание элементов интерфейса СТРАНИЦЫ 'О предприятии'"""
        ...
        # Описание предприятия
        description = QLabel(
            "Это площадка, на которой собран комплект уникального оборудования "
            "и специализированного программного обеспечения (ПО) для быстрого "
            "прототипирования и мелкосерийного производства.\n\n"
            "ЦМИТ предоставляет открытый доступ молодым ученым и школьникам, "
            "начиная с первого класса, к самым современным инструментам и "
            "подходам для производства сложных систем с использованием "
        ...
        # Разделитель (раскомментируй, если нужны карточки направлений)
        # info_layout.addWidget(self.create_separator())
        #
        # # Направления деятельности
        # directions_title = QLabel("Направления деятельности")
        ...
        # 3. Мини-карточка выхода в правом нижнем углу
        exit_layout = QHBoxLayout()
        exit_layout.addStretch()
